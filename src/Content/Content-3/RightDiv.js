...
function RightDiv() {
  return (
        ...
        {/* HEADING */}
          ...
          {/* FORM REGISTERED MOBILE NUMBER */}
          <div className="mobile-number-reg">
            <form id="reg-form" action="#">
              ...
              <div className='input-field'>
                ...
                />
                <button id="getotp-btn">Get OTP</button>
              </div>
              <p id='input-req'>
                  Mobile number should be 10 digit long and starts with 6-9 only
                  without +91
              </p>
            </form>
          </div>
          ...
          <div className="payment-methods">
            ...
            {/* payments methods svg div */}
            <div className="svg-div">
              <div className="payment-method-symbol-text-div">
                <svg
